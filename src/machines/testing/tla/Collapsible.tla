---- MODULE Collapsible ----
\* Auto-generated from @sig-ui/core/machines/collapsible.js
\* Model-based testing spec for Apalache MC
\*
\* States:   closed, opening, open, closing
\* Events:   TOGGLE, OPEN, ANIMATION_END, CLOSE
...
States == {"closed", "opening", "open", "closing"}
Events == {"TOGGLE", "OPEN", "ANIMATION_END", "CLOSE"}
Edges == {"Closed_Toggle", "Closed_Open", "Opening_AnimationEnd", "Open_Toggle", "Open_Close", "Closing_AnimationEnd"}
